 ...
 */
final class Version20221214153049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE painting (id INT AUTO_INCREMENT NOT NULL, style_id INT NOT NULL, categories_id INT NOT NULL, title VARCHAR(120) NOT NULL, descrioption VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', height DOUBLE PRECISION NOT NULL, width DOUBLE PRECISION NOT NULL, image_name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', price INT NOT NULL, INDEX IDX_66B9EBA0BACD6074 (style_id), INDEX IDX_66B9EBA0A21214B7 (categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
